...
class ProvideEmployeeTestCase(unittest.TestCase):
    ...
    def test_serialize_employee(self):
        ...
        employee.employment_date = datetime(2018, 1, 1)
        employee.acceptance_date = datetime(2018, 1, 1)
        ...
        self.assertEqual("2018.01.01", serialized_employee['acceptance_date'])
    ...
    def test_deserialize_employee(self):
        ...
        self.assertEqual(datetime(2018, 1, 1), employee.employment_date)
        self.assertEqual(datetime(2018, 1, 1), employee.acceptance_date)
